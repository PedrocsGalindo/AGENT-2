...
class LocalModel:
    ...
    def __init__(self, config: AppConfig) -> None:
        ...
        try:
            ...
            raise LocalModelError(
                ...
                "Check model availability, local cache/network access, memory, "
                "ACADEMIC_EXPLORER_AGENT_DEVICE_MAP, and "
                "ACADEMIC_EXPLORER_AGENT_TORCH_DTYPE. "
                "You can retry after setup with: py -m academic_explorer_mvp.main "
                "--query \"audio violence detection\" --min-year 2020 --max-rounds 1 --limit 5."
            ) from exc
    ...
    def generate(self, prompt: str) -> str:
        ...
        try:
            ...
            raise LocalModelError(
                "Local model generation failed. Check "
                "ACADEMIC_EXPLORER_AGENT_MAX_NEW_TOKENS, "
                "ACADEMIC_EXPLORER_AGENT_TEMPERATURE, model memory, and device setup."
            ) from exc
